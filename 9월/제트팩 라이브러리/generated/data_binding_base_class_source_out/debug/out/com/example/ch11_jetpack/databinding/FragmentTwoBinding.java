...
public final class FragmentTwoBinding implements ViewBinding {
  ...
  private FragmentTwoBinding(@NonNull LinearLayout rootView, @NonNull TextView fragmentTextView) {
  ...
  public static FragmentTwoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTwoBinding((LinearLayout) rootView, fragmentTextView);
    }
