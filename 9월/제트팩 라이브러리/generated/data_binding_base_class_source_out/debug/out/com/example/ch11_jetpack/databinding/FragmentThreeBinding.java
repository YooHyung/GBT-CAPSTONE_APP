...
public final class FragmentThreeBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView fragmentTextView;

  private FragmentThreeBinding(@NonNull LinearLayout rootView, @NonNull TextView fragmentTextView) {
  ...
  public static FragmentThreeBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.fragment_textView;
      TextView fragmentTextView = ViewBindings.findChildViewById(rootView, id);
      if (fragmentTextView == null) {
        break missingId;
      }

      return new FragmentThreeBinding((LinearLayout) rootView, fragmentTextView);
    }
